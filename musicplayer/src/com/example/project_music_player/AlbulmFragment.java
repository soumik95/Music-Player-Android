...
public class AlbulmFragment extends android.support.v4.app.ListFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ListAdapter ad=new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1,ob.albulm); 
		setListAdapter(ad);
		return rootView;
	}
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(getActivity(),AlbulmSongs.class);
